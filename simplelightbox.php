...
class SimpleLightbox {
	...
	public function load() {
		...
		wp_enqueue_script('simplelightbox', plugins_url($file, __FILE__), array(), '2.7.3', true);

		//== simplelightbox JS hook
		wp_register_script('simplelightbox-call', plugins_url('/resources/js/setup.simplelightbox.js', __FILE__), array(), '2.7.3', true);
	...
	public function load_admin_styles() {
		...
		//== js
		wp_enqueue_script('simplelightbox-colorpicker', plugins_url('/resources/js/colorpicker.min.js', __FILE__), array( 'jquery' ), '2.7.3', true);
		wp_enqueue_script('simplelightbox-admin-js', plugins_url('/resources/js/ar-sl-admin.js', __FILE__), array( 'jquery' ), '2.7.3', true);
	}
